...
**Tungtveiende motpresedens — les `bakgrunn/18` før du gjør noe annet.** NFFs forsikringsutvalg gjorde i 2024/25 nesten identisk tingvedtatt gjennomgang og **forkastet både reduserte dekninger og frivillighet i kjernen** («alle bør ha en grunnforsikring»), med fordelingsbegrunnelse: reduserte dekninger gir større økonomiske barrierer og mindre solidaritet fordi de med god økonomi kjøper seg tilleggsdekning. Fotballen valgte gradvis tilpasning av premie til skadekostnad per gruppe — i praksis modell A. To funn som treffer vårt materiale hardt: (1) premieveksten drives av **strukturell skadeutvikling**, ikke produktstruktur — det offentlige har trukket seg ~90 % ut av idrettsmedisinsk kirurgi siden 2019, så B/C flytter prisproblemet i stedet for å løse det; (2) en 15-åring i fotball er dekket for **420 kr** (2026, bekreftet fotball.no) mot 5 200 kr for utvidet alpinlisens, med samme dekningsstruktur og samme leverandørapparat (Idrettens skadetelefon/IHS) — forskjellen er poolstørrelse, ikke produktdesign. Dette er det sterkeste argumentet for modell D/E/F i hele grunnlaget. **Praktisk neste steg:** kontakt IHS-sekretariatet (Espen Rooth / Erlend Yden) og NFF (Stein Pedersen) direkte — de har gjort analysen NSF nå skal gjøre, med samme leverandør.
...
- ✔ **Underskuddsperioden er avklart:** 4,2 MNOK gjelder **2021–2024** (bekreftet 11.08.2026 mot to nyhetskilder som siterer Skistyrets vedtak 27.08.2024). «2019–2024» var feil og er rettet.
- ○ **Subsidieringen står fortsatt åpen:** 1,2/1,0 MNOK (Vedlegg 7) mot 1,6/2,0 MNOK (Skistyret). Finnes **ikke** i noen åpen kilde — verken årsberetningene 2024–25/2025–26 (fulltekstsøkt), styreprotokollene eller pressen. Må hentes fra NSFs interne saksdokumenter.
- ✔ **Aldersgrensen var ikke et avvik:** 70 år = obligatorisk lisens, 71–80 = frivillig, ikke tegnbar etter 80 (Fellesreglementet 203.3.1 og 203.3.4, verifisert). Begge tall var korrekte.
- ○ **Tingprotokollen er ikke offentlig tilgjengelig:** Skitinget 2026 ble avholdt 6.–7. juni, men protokollen er ikke publisert, og NSFs sakslistearkiv gir HTTP 500. Sak 11.3-vedtaket kan ikke gjengis ordrett fra åpne kilder — **må komme fra sekretariatet**.
- ○ Aldersfordelingen summerer ikke til totalt aktive (gap 4,5–6 %), uforklart.
- ○ **«+126 %» for langrenn er nå aktivt omstridt:** vårt underlag sier 740/2 600 for 24/25, pressen (som siterer Skistyrets vedtak) sier 880 → 1 990. 2025/26-prisen (650/2 400) er derimot verifisert. **Ikke bruk +126 % før 24/25-listen er hentet internt.**
